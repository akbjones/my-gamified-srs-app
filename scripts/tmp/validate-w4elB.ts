/* Full validation for wave-4 slice B (el-2551..el-2800). */
...
const ROOT = dir + '../../';
const cards = JSON.parse(readFileSync(dir + 'wave4-el-cards-B.json', 'utf8'));
const dict = JSON.parse(readFileSync(dir + 'wave4-el-dict-B.json', 'utf8'));
const verbs: string[] = JSON.parse(readFileSync(dir + 'wave4-el-verbs-B.json', 'utf8'));
...
cards.forEach((c: any, i: number) => {
  ...
  const wantNode = n <= 2675 ? 'node-23' : 'node-24';
