...
export const WELSH_ETYMOLOGY: Record<string, EtymologyEntry> = {
  ...
  'crwth': {
    ...
    origin: 'Welsh crwth',
    cognates: ['crowd'],
    note: 'An ancient Welsh bowed lyre — English borrowed it as "crowd" (the musical instrument, unrelated to a crowd of people).',
    verified: true,
    sources: ['wiktionary', 'etymonline'],
  },
  'cwtch': {
  ...
  'crag': {
    ...
    cognates: ['crag'],
    note: 'Means "rocky outcrop" — entered English from Brittonic Celtic in early medieval times, common in northern English place names.',
    verified: true,
    sources: ['wiktionary', 'etymonline'],
  },
};
