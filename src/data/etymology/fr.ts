...
export const FRENCH_ETYMOLOGY: Record<string, EtymologyEntry> = {
  ...
  'mère': {
    ...
    note: 'Same ancient root as English "mother", Sanskrit mātṛ — Indo-European parent-word.',
    verified: true,
    sources: ['wiktionary', 'etymonline', 'cnrtl'],
  },
  'père': {
    ...
    note: 'Same ancient root as English "father", Sanskrit pitṛ, German Vater — universal across millennia.',
    verified: true,
    sources: ['wiktionary', 'etymonline', 'cnrtl'],
  },
  'jour': {
  ...
  'café': {
    ...
    note: 'Arabic qahwa → Turkish kahve → Italian caffè → French café → English "café" and "coffee" both.',
    verified: true,
    sources: ['wiktionary', 'etymonline', 'cnrtl'],
  },
  'monde': {
  ...
  'boutique': {
    ...
    note: 'Greek apothēkē meant "storeroom" — same root gave English "apothecary" (the pharmacist storing remedies).',
    verified: true,
    sources: ['wiktionary', 'etymonline', 'cnrtl'],
  },
  'ballet': {
