...
export const ITALIAN_ETYMOLOGY: Record<string, EtymologyEntry> = {
  ...
  'pizza': {
    ...
    cognates: ['pizza'],
    note: 'First recorded in Gaeta, Italy in 997 CE — entered English in 1825 but only became common after WWII.',
    verified: true,
    sources: ['wiktionary', 'etymonline'],
  },
  'paparazzi': {
    word: 'paparazzi',
    origin: 'Italian Paparazzo (character name)',
    cognates: ['paparazzi'],
    note: 'Named after Paparazzo, a photographer in Fellini\'s 1960 film La Dolce Vita — entered English directly.',
    verified: true,
    sources: ['wiktionary', 'etymonline'],
  },
};
