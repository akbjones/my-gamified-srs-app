...
export const GRAMMAR_NUDGES: Partial<Record<Language, Record<string, string>>> = {
  ...
  welsh: {
    ...
    'node-25': 'This sentence involves sports or hobbies — "chwarae pêl-droed" (play football), "garddio" (gardening). Rugby is "rygbi" and is very popular.',
    'node-26': 'This sentence involves nature or environment — "coed" (trees), "mynydd" (mountain). Welsh has rich vocabulary for landscape features.',
    'node-27': 'This sentence involves media or technology — "cyfrifiadur" (computer), "ffôn symudol" (mobile phone). Tech Welsh is actively developed.',
