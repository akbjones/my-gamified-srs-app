...
export const GRAMMAR_NUDGES: Partial<Record<Language, Record<string, string>>> = {
  ...
  hindi: {
    'node-01': 'This sentence uses basic greetings — "namaste", "aap kaise hain?" are daily essentials. Hindi has formal/informal register from the start.',
    ...
    'node-05': 'This sentence uses numbers or time — Hindi has unique words for 1-100. Time uses "बजे" (o\'clock): "तीन बजे" (at three o\'clock).',
    'node-06': 'This sentence is about food or ordering — "मुझे...चाहिए" (I need) is the standard request form. Hindi cuisine vocabulary is rich and varied.',
    'node-07': 'This sentence involves family — Hindi has specific terms for every family relationship: "चाचा" (father\'s brother), "मामा" (mother\'s brother).',
    ...
    'node-12': 'This sentence involves daily routine — Hindi uses compound verbs extensively: "उठ जाना" (get up), "सो जाना" (fall asleep).',
    ...
    'node-15': 'This sentence uses adjective agreement — adjectives ending in -ा change: बड़ा/बड़ी/बड़े. Invariable adjectives like "सुंदर" don\'t change.',
    ...
    'node-17': 'This sentence involves directions or transport — "सीधे जाइए" (go straight), "दाएँ मुड़िए" (turn right). Hindi uses auto-rickshaw culture.',
  ...
  turkish: {
    'node-01': 'This sentence uses basic greetings — "Merhaba", "Nasılsınız?" are daily essentials. Turkish uses both formal (siz) and informal (sen).',
    ...
    'node-05': 'This sentence uses numbers or time — Turkish numbers are straightforward. Time: "Saat kaç?" (What time is it?).',
    'node-06': 'This sentence is about food — "Hesap lütfen" (Check please). Turkish cuisine has rich vocabulary around kebap, meze, çay.',
    'node-07': 'This sentence involves family — Turkish has specific terms: "abi" (older brother), "abla" (older sister), "amca" (paternal uncle).',
    ...
    'node-12': 'This sentence involves daily routine — reflexive verbs use personal possessive: "yıkanmak" (to wash oneself).',
    ...
    'node-17': 'This sentence involves directions — "sağa dönün" (turn right), "düz gidin" (go straight). Turkish minibus (dolmuş) culture.',
  ...
  russian: {
    'node-01': 'This sentence uses basic greetings — "Здравствуйте", "Как дела?" are daily essentials. Russian distinguishes ты (informal) and вы (formal).',
    'node-02': 'This sentence uses 1st conjugation present — verbs ending in -ать/-ять/-еть: "читаю, читаешь, читает" etc.',
    ...
    'node-05': 'This sentence uses numbers or time — Russian numbers trigger different cases: 1=nominative, 2-4=genitive singular, 5+=genitive plural.',
    'node-06': 'This sentence is about food — "Принесите, пожалуйста..." (Please bring...). Russian cuisine vocabulary: борщ, блины, пельмени.',
    'node-07': 'This sentence involves family — Russian kinship: "тётя" (aunt), "дядя" (uncle), "бабушка" (grandmother), "дедушка" (grandfather).',
    ...
    'node-12': 'This sentence involves reflexive verbs — ending in -ся/-сь: "умываться" (wash oneself), "одеваться" (get dressed).',
    ...
    'node-15': 'This sentence uses adjective agreement — adjectives match nouns in gender, number, case: "красивый дом", "красивая книга".',
    'node-16': 'This sentence uses accusative case — direct objects and direction: "Я вижу книгу" (I see the book), "Я иду в школу".',
    'node-17': 'This sentence involves directions — "Поверните направо" (Turn right), "Идите прямо" (Go straight). Metro vocab is essential.',
    'node-18': 'This sentence uses dative case — indirect objects and age: "Мне 25 лет" (I am 25), "Я дал ему книгу" (I gave him a book).',
    ...
    'node-22': 'This sentence uses instrumental case — "с" (with) + inst, means/tool: "Я пишу ручкой" (I write with a pen).',
