...
export const GRAMMAR_NUDGES: Partial<Record<Language, Record<string, string>>> = {
  ...
  swedish: {
    'node-01': 'This sentence uses basic greetings — "hej", "god morgon", "hur mår du?" are daily essentials in Swedish.',
    ...
    'node-05': 'This sentence shows V2 word order — the conjugated verb must be the second element in main clauses, even after time or place phrases.',
    'node-06': 'This sentence uses numbers or time expressions — Swedish tells time with "halv" meaning half TO the next hour: "halv tre" = 2:30.',
    'node-07': 'This sentence is about food or ordering — "fika" (coffee break) culture is central to Swedish life.',
    ...
    'node-12': 'This sentence involves daily routine or reflexive verbs — "tvätta sig" (wash oneself), "klä på sig" (get dressed).',
    ...
    'node-17': 'This sentence involves directions or transport — Swedish cycling culture and public transit vocabulary.',
  ...
  welsh: {
    'node-01': 'This sentence uses basic greetings — "Bore da", "Nos da", "Shwmae?" are daily essentials in Welsh.',
    'node-02': 'This sentence uses present tense with bod — "Dw i" (I am), "Mae e" (He is). Bod is THE verb in Welsh, used to form most tenses.',
    'node-03': 'This sentence is a question or answer — Welsh questions use "Ydych chi...?", "Oes...?", "Beth...?" with specific word order patterns.',
    'node-04': 'This sentence involves articles and gender — Welsh has "y/yr" (the) and no indefinite article. Feminine nouns trigger soft mutation after the article.',
    'node-05': 'This sentence uses numbers or time — Welsh has two number systems (traditional vigesimal and modern decimal). Time uses "am" for at.',
    'node-06': 'This sentence is about food or ordering — "Hoffwn i..." (I would like) is polite ordering. Welsh café culture uses "paned" (cuppa) frequently.',
    'node-07': 'This sentence involves family — Welsh kinship terms like "mam-gu" (grandmother), "tad-cu" (grandfather) vary by region (North vs South).',
    'node-08': 'This sentence involves places or directions — "Ble mae...?" (Where is...?), "Trowch i\'r chwith" (Turn left). Welsh place names are descriptive.',
    ...
    'node-12': 'This sentence involves weather or seasons — "Mae hi\'n bwrw glaw" (It\'s raining). Welsh weather is described using "Mae hi\'n..." (It is...).',
    'node-13': 'This sentence involves shopping or money — "Faint mae hwn yn gostio?" (How much does this cost?). Welsh uses "punt" for pound.',
    'node-14': 'This sentence involves health or body — "Dw i\'n teimlo\'n sâl" (I feel sick). Body parts take definite forms in possession contexts.',
    'node-15': 'This sentence uses comparison — Welsh comparatives add "-ach": mawr → mwy, da → gwell. Superlatives use "-af": mwyaf, gorau.',
    'node-16': 'This sentence involves transport or travel — "trên" (train), "bws" (bus). Welsh transport vocab includes "gorsaf" (station).',
    'node-17': 'This sentence involves work or professions — "Beth ydych chi\'n wneud?" (What do you do?). Professions use "yn" + soft mutation.',
    'node-18': 'This sentence involves education — "ysgol" (school), "prifysgol" (university). Welsh-medium education uses "addysg Gymraeg".',
    'node-19': 'This sentence uses the imperative — commands use verb stem directly: "Dewch!" (Come!), "Ewch!" (Go!). Negative: "Paid â..." (Don\'t...).',
    'node-20': 'This sentence shows soft mutation — triggered by "yn", after feminine "y", after "i", after "dy": c→g, p→b, t→d, g→drops, b→f, d→dd, m→f.',
    'node-21': 'This sentence uses nasal or aspirate mutation — nasal after "fy" (my): c→ngh, p→mh, t→nh. Aspirate after "a" (and), "â" (with): c→ch, p→ph, t→th.',
    ...
    'node-28': 'This sentence uses a Welsh idiom — "dal dŵr" (hold water/be valid), "rhoi\'r ffidil yn y to" (give up). Idioms add native-like fluency.',
    ...
    'node-30': 'This sentence reflects Welsh culture — eisteddfod, cawl, cwm, hiraeth are culturally embedded concepts without direct English equivalents.',
    ...
    'node-33': 'This sentence uses academic Welsh — formal argumentation, "ymddengys" (it appears), "gellir dadlau" (it can be argued) in professional discourse.',
    'node-34': 'This sentence references Welsh literature — poets like Dafydd ap Gwilym, the Mabinogion, and modern Welsh writing traditions.',
