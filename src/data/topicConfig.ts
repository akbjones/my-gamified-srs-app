...
export const NODE_NAMES: Partial<Record<Language, Record<string, string>>> = {
  ...
  // Japanese ladder per docs/japanese-scoping.md — the 300-card starter
  // populates nodes 1-18 thinly; 19-35 densify at parity expansion.
  japanese: {
    'node-01': 'Greetings & set phrases',
    'node-02': 'は & です basics',
    'node-03': 'Questions with か',
    'node-04': 'This & that (これ/それ/あれ)',
    'node-05': 'が & existence (います/あります)',
    'node-06': 'を & polite verbs (ます)',
    'node-07': 'Direction & time (に/へ)',
    'node-08': 'Place & means (で)',
    'node-09': 'Negatives & invitations',
    'node-10': 'Polite past (ました)',
    'node-11': 'i-adjectives',
    'node-12': 'na-adjectives',
    'node-13': 'Linking with の',
    'node-14': 'Numbers, counters & time',
    'node-15': 'も, と & や',
    'node-16': 'Requests (てください)',
    'node-17': 'て-form & ています',
    'node-18': 'Wants & likes (たい/好き)',
    'node-19': 'Plain form & んです',
    'node-20': 'Experience (たことがある)',
    'node-21': 'Plain negative (ない)',
    'node-22': 'Potential form',
    'node-23': 'Comparisons (より/ほうが)',
    'node-24': 'Because & but (から/ので/けど)',
    'node-25': 'Suggestions (ましょう)',
    'node-26': 'Giving & receiving',
    'node-27': 'Conditionals (と/たら)',
    'node-28': 'Noun-modifying clauses',
    'node-29': 'Obligation (なければ)',
    'node-30': 'Permission & prohibition',
    'node-31': 'Seems like (そう/よう)',
    'node-32': 'Basic keigo',
    'node-33': 'Casual speech',
    'node-34': 'Quoting (と思う/と言う)',
    'node-35': 'Native-style mastery',
  },
};
