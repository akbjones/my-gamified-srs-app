...
export const NODE_NAMES: Partial<Record<Language, Record<string, string>>> = {
  ...
  dutch: {
    ...
    'node-12': 'Daily routine & reflexives',
  ...
  welsh: {
    ...
    'node-12': 'Weather & seasons',
    'node-13': 'Shopping & money',
    'node-14': 'Health & body',
    'node-15': 'Comparatives & superlatives',
    'node-16': 'Transport & travel',
    'node-17': 'Work & professions',
    'node-18': 'Education & learning',
    ...
    'node-30': 'Welsh culture & traditions',
  ...
  russian: {
    ...
    'node-12': 'Daily routine & reflexive verbs',
