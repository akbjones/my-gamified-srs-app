...
// 'greek'/'korean'/'msa' are staged (registry + audits only) ahead of app-side Language integration
const GOOGLE_VOICE_MAP: Record<Language | 'greek' | 'korean' | 'msa', { languageCode: string; name: string }> = {
